...
root = tk.Tk()
root.title("Ember Notes")
root.geometry("500x500")
style = ttk.Style()
style = Style(theme='darkly')

# Load the image and create an ImageTk object
icon_img = Image.open("ember_icon.png")
...
# Create a function for Light and Dark Mode
default_theme = True
...
def add_note():
    ...
    notebook.select(note_frame)  # switch to the new note tab
...
theme_button = ttk.Button(root, text="Switch Theme",
                           command=toggle_theme, style="theme.TButton")
